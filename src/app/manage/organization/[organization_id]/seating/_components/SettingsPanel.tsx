                    ...
                    {selectedBlock.type === 'seated_grid' && (
                        <>
                            <div className="space-y-2">
                                ...
                                <Input id="rows" type="number" value={formData.rows || ''}
                                       onChange={e => handleChange('rows', parseInt(e.target.value))}/>
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="columns">Columns</Label>
                                <Input id="columns" type="number" value={formData.columns || ''}
                                       onChange={e => handleChange('columns', parseInt(e.target.value))}/>
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="startRowLabel">Start Row Label</Label>
                                <Input id="startRowLabel" value={formData.startRowLabel || ''}
                                       onChange={e => handleChange('startRowLabel', e.target.value.toUpperCase())}/>
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="startColumnLabel">Start Column Number</Label>
                                <Input id="startColumnLabel" type="number" value={formData.startColumnLabel || ''}
                                       onChange={e => handleChange('startColumnLabel', parseInt(e.target.value))}/>
                            </div>
                        </>
                    )}
