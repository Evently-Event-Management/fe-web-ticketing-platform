...
// UseFormGetValues is no longer needed
...
// CreateEventFormData is no longer needed
import {Alert, AlertDescription, AlertTitle} from '@/components/ui/alert';
import {useTheme} from "next-themes";

// --- 1. UPDATE THE PROPS INTERFACE ---
interface GeminiMarkdownEditorStandAloneProps {
    value: string;
    onChange: (value: string) => void;
    organizationName: string;
    // Remove the dependency on react-hook-form's getValues
...
export function GeminiMarkdownEditorStandAlone({
                                         value,
                                         onChange,
                                         organizationName,
                                         ...
                                         eventDescription,
                                         eventCategory
                                     }: GeminiMarkdownEditorStandAloneProps) {
    ...
    const handleGenerate = async () => {
        if (!eventTitle) {
            toast.error("Please ensure an Event Title is provided before generating an overview.");
            return;
        }
        ...
        try {
            const request = {
                title: eventTitle, // Use the prop
                organization: organizationName,
                description: eventDescription || '', // Use the prop
                category: eventCategory || '', // Use the prop
