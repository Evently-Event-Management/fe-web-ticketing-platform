...
export function useSessionColumns(): ColumnDef<SessionSummary>[] {
    ...
    return [
        {
            ...
            cell: ({row}) => {
                ...
                return (
                    <Link href={`/manage/organization/${organizationId}/event/${eventId}/sessions/${session.sessionId}/analytics`}
