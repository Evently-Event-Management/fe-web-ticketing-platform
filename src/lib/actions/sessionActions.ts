...
/**
 * Request type for updating session venue
 */
...
/**
 * Request type for updating session seating
 */
export interface SessionLayoutUpdateRequest {
...
export const updateSessionVenue = (
    ...
    return apiFetch<SessionDetailDTO>(`${API_BASE_PATH}/sessions/${sessionId}/venue-details`, {
        method: 'PUT',
 ...
 *
 * @param sessionId ID of the session to update
 * @param layout New seating layout data
 * @returns The updated session details
 */
export const updateSessionLayout = (
    sessionId: string,
    layout: SessionLayoutUpdateRequest
): Promise<SessionDetailDTO> => {
    return apiFetch<SessionDetailDTO>(`${API_BASE_PATH}/sessions/${sessionId}/layout`, {
        method: 'PUT',
