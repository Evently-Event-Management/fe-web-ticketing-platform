...
export const getTierColor = (tierId: string, session: SessionFormData, tiers: TierFormData[]): string => {
...
export const getTierName = (tierId: string, session: SessionFormData, tiers: TierFormData[]): string => {
